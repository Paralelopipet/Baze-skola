...
namespace Arhiva
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (cm == null || String.IsNullOrWhiteSpace(cm.ConnectionString)) otvoriDialogZaKonekcioniString();
            Konekcija.konekcionistring = ConfigurationManager.ConnectionStrings["ArhivaConnectionString"].ConnectionString;
            if(!Konekcija.testConnection()) otvoriDialogZaKonekcioniString();
            connectionString = Konekcija.konekcionistring;
        }


        private void otvoriDialogZaKonekcioniString()
        {
            using (var form = new UnosKonekcionogStringa())
            {
